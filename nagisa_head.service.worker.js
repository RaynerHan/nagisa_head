...
/** @type {string} */
const CACHE_VERSION = '1726989773|367881098';
/** @type {string} */
const CACHE_PREFIX = 'Parallax Eyes-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'nagisa_head.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["nagisa_head.html","nagisa_head.js","nagisa_head.offline.html","nagisa_head.icon.png","nagisa_head.apple-touch-icon.png","nagisa_head.worker.js","nagisa_head.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["nagisa_head.wasm","nagisa_head.pck"];
